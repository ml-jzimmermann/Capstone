...
def train_model_de(four_classes=True, epochs=8):
    if four_classes:
...
def train_model_en(four_classes=True, epochs=8):
    if four_classes:
        class_names = ['least', 'less', 'more', 'most']
    else:
        class_names = ['less', 'equal', 'more']
...
def train_model_mulit(four_classes=True, epochs=8):
        if four_classes:
            class_names = ['least', 'less', 'more', 'most']
        else:
            class_names = ['less', 'equal', 'more']
        ...
        csv_google = '../../data/merged_ktrain_google_en_four.csv'
