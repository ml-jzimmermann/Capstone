...
results = {}
index = 0
generate_dataset(four_classes=True, sliding_window=2, spread=0.02)
result = train_model(four_classes=True)
configuration = {'four_classes': True, 'spread': 0.02, 'sliding_window': 2}
